 ...
 */
package jFrame_Guilherme;

import jaboccafeteria.Cliente;
import jaboccafeteria.Conta;
...
public class interface_editarCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cpfCliente__Editar = new javax.swing.JTextField();
        enderecoCliente_Editar = new javax.swing.JTextField();
        telefoneCliente__Editar = new javax.swing.JTextField();
        ...
        cpfCliente__Editar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cpfCliente__EditarActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(57, 57, 57)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(telefoneCliente__Editar, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(cpfCliente__Editar)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(cpfCliente__Editar, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(telefoneCliente__Editar, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void cpfCliente__EditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cpfCliente__EditarActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cpfCliente__EditarActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(Conta.verificaCPF(verificarCPF_Cliente.getText()) && Conta.verificaSenha(verificarSenha_Cliente.getText())){
            nomeCliente_Editar.setText(Conta.getTitular().getNomeCliente());
            cpfCliente__Editar.setText(Conta.getTitular().getCpfCliente());
            enderecoCliente_Editar.setText(Conta.getTitular().getEnderecoCliente());
            telefoneCliente__Editar.setText(Conta.getTitular().getTelefoneCliente());
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private void editarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarClienteActionPerformed
        Conta.getTitular().setNomeCliente(nomeCliente_Editar.getText());
        Conta.getTitular().setCpfCliente(cpfCliente__Editar.getText());
        Conta.getTitular().setEnderecoCliente(enderecoCliente_Editar.getText());
        Conta.getTitular().setTelefoneCliente(telefoneCliente__Editar.getText());
        
        nomeCliente_Editar.setText("");
        cpfCliente__Editar.setText("");
        enderecoCliente_Editar.setText("");
        telefoneCliente__Editar.setText("");
    }//GEN-LAST:event_editarClienteActionPerformed
    public void recebeCliente(Conta C){
        Conta = C;
    }
    /**
    ...
    private javax.swing.JTextField cpfCliente__Editar;
    ...
    private javax.swing.JTextField telefoneCliente__Editar;
