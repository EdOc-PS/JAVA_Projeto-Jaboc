...
public class daoConta {
    ...
    public static boolean login_ContaCliente(String cpf, String senha) throws SQLException{
        ...
        if(rsLoginC.next()){
            if(rsLoginC.getString("senhaCliente").equals(senha)){
                Carrinho.setTitularCarrinho(rsLoginC.getString("nome"));
                return true;
            }
        }
        return false;
    ...
    public static ResultSet selectFuncionarios() throws SQLException{
        
        Connection conexao = Conexao.conectar();
        
        String selectAllF = "SELECT cpfFuncionario, * FROM jaboc_servidor.Conta_Funcionarios;";
    }
