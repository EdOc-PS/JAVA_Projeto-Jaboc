 ...
 * @author eeuar
 */
public class PopUp_mensagemCarrinho extends javax.swing.JPanel {
     ...
     */
    public PopUp_mensagemCarrinho(String mensagem) {
        initComponents();
    ...
    private void conferirMensagem(String mensagem) {
        String carrinhoVazio = "Seu carrinho está vázio!";
        String carrinho = "Item adicionado ao carrinho.";
    ...
    private void initComponents() {
        ...
        jIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons/i_carrinho.png"))); // NOI18N
